...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:codeprojectsorg@gmail.com">codeprojectsorg@gmail.com</a></li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">One of the Great Hotels of the World, Our Hotel is Country’s only deluxe 5 Star Hotel. Brainchild of promoter, Mr. ABC, The Hotel was envisioned to be country’s most luxurious and exclusive property, offering amenities that a modern world-weary traveler can desire.</p>
		   ...
		   <div class="advantage-bottom">
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>VISA CARD,DEBIT,CREDIT,PAYPALS Accepted</p>
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Awesome Services.Comfortable beds. Peaceful environments and ofcourse delicious foods.This makes me to visit here again soon!! </p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+94 (65)112-00-00</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:codeprojectsorg@gmail.com">codeprojectsorg@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New ST. Road, NPL</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 HOTEL SITE . All Rights Reserved | Brought To You by <a href="https://code-projects.org/">Code-Projects</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
